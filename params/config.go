...
var (
	...
	MainnetChainConfig = &ChainConfig{
		...
		ConstantinopleBlock: big.NewInt(2102400),
		PetersburgBlock:     big.NewInt(2102400),
		IstanbulBlock:       big.NewInt(4069000),
		MuirGlacierBlock:    big.NewInt(4200000),
